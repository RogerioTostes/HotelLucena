...
public class GraficosBean {
    ...
    private final List<Reservas> reservas;
     private final List<Reservas> reservas1;
    ...
    public GraficosBean() {
       ...
       reservas1 = new ReservasDAO().buscarReservados();
    }

    @PostConstruct
    public void init() {
        this.createQuartosReservados();
        createReservasConcluidas();
    }

    public void createQuartosReservados() {
        ...
        barDataSet.setLabel("Quartos Reservados");
        ...
        title.setText("Quartos reservados");
